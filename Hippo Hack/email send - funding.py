...
#format of rawData
#  recipient name: rep contact || company \t recipient email \n ...

rawData = open("./sendData - funding.txt","r").readlines()
...
for i in range(len(rawData)):
    ...
    body = (
    	"Hi "+rawData[i][0]+","
    	+"\n\nMy name is Michael, and I am a junior at Acton-Boxborough Regional High School. I am a founder of Enginuity Tech, a "
        +"nonprofit organization, and we are hosting the Hippo Hack! Hippo Hack is a free, in-person "
        +"hackathon hosted here in Massachusetts for all students in grades 6-12 with an interest in the "
        +"field of computer science. Students will work in together groups and broaden their skills while "
        +"also employing their creativity to create a one-of-a-kind project! We are interested in whether "
        +"you could help sponsor us for this year’s Hippo Hack as well as many other tech-related events "
        +"in the future! For additional details regarding a sponsorship, refer to the attached prospectus."
